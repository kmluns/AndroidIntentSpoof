...
public class Receiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getStringExtra("attachment_path") != null){
            ...
            Log.d("app : " , "Intent Sniffing on Photo!!!");
            Toast.makeText(context, "Intent Sniffing on Photo!!!", Toast.LENGTH_SHORT).show();

            Log.d("content : ",intent.getStringExtra("content") ) ;
            Toast.makeText(context,intent.getStringExtra("content"), Toast.LENGTH_SHORT).show();

        }else{
            Log.d("app : " , "Intent Sniffing on QuickMessage!!!");
            Toast.makeText(context, "Intent Sniffing on QuickMessage!!!", Toast.LENGTH_SHORT).show();
